 ...
 */        
        ...
        uint32_t convertedSendRateMillis = 200;          // in Millis default value
    ...
    public:
        ...
        bool generateRawSensormsgs(FlexCAN& CANbus, const std::array<Sensor*, NUM_SENSORS>& sensorArray, const std::array<ALARAHP_SENSOR*, NUM_HPSENSORS>& HPsensorArray, const uint8_t& propulsionNodeIDIn);
        bool generateConvertedSensormsgs(FlexCAN& CANbus, const std::array<Sensor*, NUM_SENSORS>& sensorArray, const std::array<ALARAHP_SENSOR*, NUM_HPSENSORS>& HPsensorArray, const uint8_t& propulsionNodeIDIn);
