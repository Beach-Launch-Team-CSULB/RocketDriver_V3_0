...
std::unordered_map<uint16_t, ALARASN> ALARASNmap // Looks like these need to be reworked
{
// map key = ALARA address
    ...
    {4, ALARASN {4, 3, ALARAversion::V2_1, false, true, true, true, true, 128, 512, 0, 0, 0, 0, 0, 0}}, // ALARA VERSION == rocket driver version???
    //{5, ALARASN {5, }}
};
